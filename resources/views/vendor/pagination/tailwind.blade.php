@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="paginate" class="flex items-center justify-between">

        <!-- 件数表示 -->
        <div class="paginate_content" class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div class="page_count_content">
